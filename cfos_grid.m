...
height_ref = imline(gca, [1500 1500; 1500 1500+height]);
h1 = imline;
...
save(['E:\histology\paula\' mouse '\' mouse '_' int2str(img_num) '_rect_mask'], 'masks', 'names_key')
